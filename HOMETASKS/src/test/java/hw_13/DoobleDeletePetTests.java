...
public class DoobleDeletePetTests {
    @Test
    public void verifyPetCanBeRemoved() {
        int petIdToCreate = 305;
        ...
        Response doobleDeletedPetResponse = given().delete("https://petstore.swagger.io/v2/pet/" + petIdToCreate);

        Assert.assertEquals(404, doobleDeletedPetResponse.getStatusCode());
    }
}
